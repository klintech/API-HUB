...
const tutorials = [
  ...
  },
  {
    ...
    description: "Complete guide to uploading files to Amazon S3 with proper security and error handling.",
    author: "David Kim",
...
const categories = ["All Categories", "Payment", "Maps", "AI", "Communication", "Cloud", "API Design"]
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-3xl">
          Step-by-step guides to help you integrate APIs into your projects. Learn from practical examples with code
